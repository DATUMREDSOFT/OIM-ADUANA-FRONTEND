...
@Component({
  selector: 'app-solicitud-modificacion-usuario',
  templateUrl: './solicitud-modificacion-usuario.component.html',
  standalone: true,
  providers: [DatePipe],
...
export class AppSolicitudModificacionUsuarioComponent implements OnInit {
